...
contextBridge.exposeInMainWorld('vttLite', {
  ...
  companion: {
    ...
    broadcastEvent: event => ipcRenderer.invoke('companion:broadcastEvent', event),
    onEvent: callback => {
  ...
  storage: {
    ...
    addCombatant: (sceneId, tokenId) => ipcRenderer.invoke('store:addCombatant', sceneId, tokenId),
    removeCombatant: combatantId => ipcRenderer.invoke('store:removeCombatant', combatantId),
    patchCombat: (worldId, patch) => ipcRenderer.invoke('store:patchCombat', worldId, patch),
    patchCombatant: (combatantId, patch) => ipcRenderer.invoke('store:patchCombatant', combatantId, patch),
    ...
    createItem: (worldId, payload) => ipcRenderer.invoke('store:createItem', worldId, payload),
    patchItem: (itemId, patch) => ipcRenderer.invoke('store:patchItem', itemId, patch),
    deleteItem: itemId => ipcRenderer.invoke('store:deleteItem', itemId),
